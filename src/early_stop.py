...
def Stop_args(patience = 100, max_epochs=2000):
    return dict(stop_varnames=[StopVariable.LOSS], patience=patience, max_epochs=max_epochs, remember=Best.RANKED)

def Stop_args_clf(patience = 100, max_epochs=2000):
